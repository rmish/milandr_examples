...
// Определение константы. Задаётся либо предопределённым значением, либо
// формулой.
#define CONSTANT 10
...
int main(int argc, char *argv[])
{
  ...
  printf("Мяф\nМяф\n!\n");
  // для работы консоли gdb в windows нужно синхронизировать буфер
  fflush(stdout);
  ...
  // завершение функции и возврат из неё значения.
  // Возврат 0 означает нормальное завершение програмыы.
  return (0);
}
